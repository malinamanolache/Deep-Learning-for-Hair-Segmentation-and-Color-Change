...
# model = Unet()
# model.to(device)
# summary(model, (3, 223, 223))

# train_set = HairSegmentationDataset()
...
# Initialize model for VGG training 
vgg = VGG()
# temp = torchvision.models.vgg16(pretrained=True)
vgg.load_state_dict(torch.load("/shared_storage/manolac/network_vgg/models_pretrained_vgg/vgg16_pretrained.pth"), strict = False)
# freeze layers
